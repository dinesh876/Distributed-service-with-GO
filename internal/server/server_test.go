...
import (
	...
	"github.com/dinesh876/proglog/internal/config"
	"github.com/dinesh876/proglog/internal/log"
...
func setupTest(t *testing.T,fn func(*Config))(
    ...
    // configure Client's ROOT CA to verify the server
    ...
    // starting a server at the backend cause it's blocked operation
    go func(){
        server.Serve(l)
    }()
